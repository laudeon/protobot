...
const recastResponse = require('./../recastResponse')
...
module.exports.vroum = (bot, message) => {
  ...
  location = recastResponse.getEntity(message, LOCATION_ENTITY)
  datetime = recastResponse.getEntity(message, DATETIME_ENTITY)
